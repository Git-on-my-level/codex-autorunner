...
WEB_UI_SCENARIOS: tuple[WebUiScenario, ...] = (
    ...
    _scenario(
        ...
        frontend_mappers=("repoWorktree.ts", "chat.ts"),
        tags=(ScenarioTag.FAST, ScenarioTag.BROWSER, ScenarioTag.CRITICAL),
    ...
    _scenario(
        ...
        frontend_mappers=("ticket.ts", "chat.ts"),
        tags=(ScenarioTag.FAST, ScenarioTag.BROWSER, ScenarioTag.CRITICAL),
    ),
    _scenario(
        ...
        frontend_mappers=("chat.ts", "readModelClients.ts"),
        tags=(ScenarioTag.FAST, ScenarioTag.BROWSER, ScenarioTag.CRITICAL),
    ),
    _scenario(
        ...
        api_routes=("/hub/pma/threads",),
        frontend_mappers=("chat.ts", "readModelClients.ts", "readModelStore.ts"),
        tags=(ScenarioTag.FAST, ScenarioTag.BROWSER, ScenarioTag.LARGE_STATE),
        notes=(
    ...
    _scenario(
        scenario_id="pma_discord_web_handoff_no_duplicates",
        title="PMA Discord-to-web handoff renders without duplicate commentary",
        route_name="chat",
        ...
        tags=(ScenarioTag.FAST, ScenarioTag.BROWSER, ScenarioTag.CRITICAL),
        loading_behavior=LoadingBehavior.MAY_STREAM,
        notes="Regression: Discord-started thread viewed on web must not duplicate activity cards.",
    ),
    _scenario(
        scenario_id="pma_grouped_tools_multi_provenance",
        title="PMA grouped tools preserve multi-event provenance",
        route_name="chat",
        ...
        tags=(ScenarioTag.FAST, ScenarioTag.BROWSER, ScenarioTag.CRITICAL),
        loading_behavior=LoadingBehavior.MAY_STREAM,
        notes="Grouped tool items must expose all contributing source/progress event ids.",
    ),
    _scenario(
