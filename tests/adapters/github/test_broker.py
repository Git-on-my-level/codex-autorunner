...
import codex_autorunner.adapters.github.broker as github_broker
from codex_autorunner.adapters.github.broker import GitHubCliBroker
from codex_autorunner.adapters.github.service import GitHubError, GitHubService
...
class TestLooksLikeRateLimitIsSharedClassifier:
    def test_broker_exports_shared_classifier(self) -> None:
        from codex_autorunner.adapters.github.broker import looks_like_rate_limit
    ...
    def test_service_uses_shared_classifier(self) -> None:
        from codex_autorunner.adapters.github import broker, service

        assert service.looks_like_rate_limit is broker.looks_like_rate_limit

    def test_polling_uses_shared_classifier(self) -> None:
        from codex_autorunner.adapters.github import broker, polling
