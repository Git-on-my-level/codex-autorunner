...
def _patch_newt_branch_reset(
    ...
    monkeypatch.setattr(
        "codex_autorunner.adapters.telegram.handlers.commands.execution._sync_telegram_thread_binding",
        _fake_sync_binding,
    )
...
async def test_newt_dirty_worktree_reports_blockers_with_submodule_context(
    ...
    monkeypatch.setattr(
        "codex_autorunner.adapters.telegram.handlers.commands.workspace_session_commands.describe_newt_reject_state",
