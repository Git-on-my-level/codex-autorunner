...
ALLOWED_RAW_RESPONSE_MODULES = {
    "src/codex_autorunner/adapters/discord/adapter.py",
    "src/codex_autorunner/adapters/discord/interaction_session.py",
}
...
ALLOWED_LOW_LEVEL_RESPONSE_HELPER_MODULES = {
    "src/codex_autorunner/adapters/discord/effects.py",
...
HANDLER_FACING_RUNTIME_MODULES = {
    ...
    "src/codex_autorunner/adapters/discord/pma_commands.py",
    "src/codex_autorunner/adapters/discord/workspace_commands.py",
    *{
        path.as_posix()
...
def test_contract_leaf_runtime_modules_import_without_discord_service_side_effects() -> (
    ...
    subprocess.run(
        [
            ...
            (
                "import importlib; "
                "importlib.import_module('codex_autorunner.adapters.discord.interaction_runtime'); "
                "importlib.import_module('codex_autorunner.adapters.discord.interaction_session'); "
                "importlib.import_module('codex_autorunner.adapters.discord.effects')"
            ),
        ],
        check=True,
...
EXTRACTED_MODULE_SEAMS: dict[str, set[str]] = {
    "src/codex_autorunner/adapters/discord/service_lifecycle.py": {
        "service_uptime_ms",
        "is_within_cold_start_window",
        "reap_managed_processes",
    },
    "src/codex_autorunner/adapters/discord/outbox.py": {
        "start_outbox_delivery_loop",
    },
    "src/codex_autorunner/adapters/discord/progress_leases.py": {
        "DiscordTurnStartupFailure",
    },
    "src/codex_autorunner/adapters/discord/managed_thread_routing.py": {
    ...
    "src/codex_autorunner/adapters/discord/interaction_scheduler.py": {
        "schedule_ingressed_interaction",
        "ScheduleResult",
    },
    "src/codex_autorunner/adapters/discord/interaction_slash_builders.py": {
        "ROOT_COMMANDS",
    },
...
def test_contract_long_running_component_handlers_show_immediate_progress() -> None:
    ...
    targets = {
        "src/codex_autorunner/adapters/discord/car_handlers/session_commands.py": (
            "handle_car_newt_hard_reset",
        ),
        "src/codex_autorunner/adapters/discord/flow_commands.py": (
            "handle_flow_button",
        ),
        "src/codex_autorunner/adapters/discord/interaction_component_handlers.py": (
            "_handle_flow_action_select_component",
        ),
        "src/codex_autorunner/adapters/discord/car_handlers/queue_interrupt_handlers.py": (
