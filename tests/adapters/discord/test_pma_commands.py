...
async def test_pma_status_includes_process_summary_when_warning(
    ...
    monkeypatch.setattr(
        "codex_autorunner.adapters.discord.pma_commands.build_process_monitor_lines_for_root",
...
async def test_pma_command_registration_includes_pma_commands() -> None:
    from codex_autorunner.adapters.discord.commands import (
...
async def test_car_processes_returns_process_summary(
    ...
    monkeypatch.setattr(
        "codex_autorunner.adapters.discord.workspace_commands.build_process_monitor_lines_for_root",
        lambda *_args, **_kwargs: [
