...
from codex_autorunner.adapters.discord.effects import (
...
from codex_autorunner.adapters.discord.gateway import (
...
def _make_ctx(
    *,
    ...
    from codex_autorunner.adapters.discord.ingress import IngressContext
...
async def test_gateway_emits_reconnect_lifecycle_logs(
    ...
    from codex_autorunner.adapters.discord import gateway as gateway_module
