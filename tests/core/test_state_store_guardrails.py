...
ALLOWED_RAW_STATE_PATH_FILES = {
    ...
    "src/codex_autorunner/adapters/discord/flow_watchers.py",
    "src/codex_autorunner/adapters/discord/outbox.py",
    "src/codex_autorunner/adapters/discord/service.py",
    "src/codex_autorunner/adapters/github/polling_discovery.py",
    "src/codex_autorunner/adapters/telegram/config.py",
    "src/codex_autorunner/adapters/telegram/doctor.py",
