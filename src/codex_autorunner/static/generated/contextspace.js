...
import { api, flash, setButtonLoading } from "./utils.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
import { initAgentControls, getSelectedAgent, getSelectedProfile, getSelectedModel, getSelectedReasoning, } from "./agentControls.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
import { fetchContextspace, ingestSpecToTickets, listTickets, writeContextspace, } from "./contextspaceApi.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
import { applyDraft, discardDraft, fetchPendingDraft, sendFileChat, interruptFileChat, newClientTurnId, } from "./fileChat.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
import { DocEditor } from "./docEditor.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
import { createDocChat } from "./docChatCore.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
import { initChatPasteUpload } from "./chatUploads.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
...
import { DEFAULT_FILEBOX_BOX } from "./fileboxCatalog.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
import { isRepoHealthy } from "./health.js?v=510fd0419ed9eddfa5851d4093853609591d2a4765ecd74f3add9600783da27f";
...
function loadOwnedPendingWorkspaceTurn(expected) {
...
async function doResumeWorkspaceTurn(pending, tracker) {
    const chatState = workspaceChat.state;
    const stillOwned = () => loadOwnedPendingWorkspaceTurn(pending) !== null;
    const scheduleOwnedRetry = () => {
    ...
    try {
        const clientTurnId = typeof activePending.clientTurnId === "string" ? activePending.clientTurnId : "";
