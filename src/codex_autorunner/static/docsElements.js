...
export const chatUI = {
    ...
    agentSelect: document.getElementById("doc-agent-select"),
    modelSelect: document.getElementById("doc-model-select"),
    reasoningSelect: document.getElementById("doc-reasoning-select"),
};
