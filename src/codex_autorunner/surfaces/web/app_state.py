...
_load_hub_inbox_dismissals = hub_inbox_resolution.load_hub_inbox_dismissals
_message_resolution_state = hub_inbox_resolution.message_resolution_state
_message_resolvable_actions = hub_inbox_resolution.message_resolvable_actions
_record_message_resolution = hub_inbox_resolution.record_message_resolution
