"""Shared hub-control-plane client, capability checks, and managed-thread helpers.
...
def build_hub_control_plane_url(config, path: str) -> str:
...
def fetch_managed_thread_status_payload(
    ...
    *,
    ...
    return request_json(
        "GET",
        build_hub_control_plane_url(config, f"/threads/{managed_thread_id}/status"),
