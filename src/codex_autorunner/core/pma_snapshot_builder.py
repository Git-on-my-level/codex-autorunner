...
def _compact_service_entry(service: Mapping[str, Any]) -> dict[str, Any]:
    return {
        ...
        "service_class": _truncate(str(service.get("service_class") or ""), 80),
        "trust_level": _truncate(str(service.get("trust_level") or ""), 80),
        "ownership": _truncate(str(service.get("ownership") or ""), 80),
