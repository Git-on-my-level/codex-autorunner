...
from .ticket_flow_stale_alive import ticket_flow_annotate_stale_alive_health
...
def _annotate_stale_alive_health(
    ...
    *,
    ...
    try:
        ...
        last_event_at = None
    return ticket_flow_annotate_stale_alive_health(
        repo_root, record, health, last_event_at=last_event_at, now=now
    )
