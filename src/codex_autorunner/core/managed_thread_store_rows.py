...
class ManagedThreadRecord:
    ...
    @classmethod
    def from_store_mapping(cls, data: Mapping[str, Any]) -> "ManagedThreadRecord":
        ...
        if managed_thread_id is None:
            raise ValueError("ManagedThreadRecord requires a managed_thread_id")
    ...
    @classmethod
    def from_orchestration_row(cls, row: Any) -> "ManagedThreadRecord":
        metadata = (
