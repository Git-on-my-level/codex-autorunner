...
_COMMAND_CONTRACT_BASE: tuple[CommandContractEntry, ...] = (
    ...
    CommandContractEntry(
        ...
        requires_bound_workspace=True,
        status="stable",
        telegram_commands=("retire",),
        discord_paths=(("car", "retire"),),
        discord_ack_policy="defer_ephemeral",
        discord_exposure="public",
    ),
    ...
    CommandContractEntry(
        id="car.flow.retire",
        path=("car", "flow", "retire"),
        requires_bound_workspace=True,
        status="partial",
        telegram_commands=("flow",),
        discord_paths=(("flow", "retire"),),
        discord_ack_policy="defer_ephemeral",
        discord_exposure="public",
        required_capabilities=("ticket_flow",),
    ),
    ...
    CommandContractEntry(
        ...
        path=("car", "automation", "list"),
        requires_bound_workspace=False,
        status="partial",
        telegram_commands=("automation",),
        discord_paths=(("car", "automation", "list"),),
        discord_ack_policy="defer_ephemeral",
        discord_exposure="public",
    ),
    CommandContractEntry(
        id="car.automation.status",
        path=("car", "automation", "status"),
        requires_bound_workspace=False,
        status="partial",
        telegram_commands=("automation",),
        discord_paths=(("car", "automation", "status"),),
        discord_ack_policy="defer_ephemeral",
        discord_exposure="public",
    ),
    CommandContractEntry(
        id="car.automation.run",
        path=("car", "automation", "run"),
        requires_bound_workspace=False,
        status="partial",
        telegram_commands=("automation",),
        discord_paths=(("car", "automation", "run"),),
        discord_ack_policy="defer_ephemeral",
        discord_exposure="public",
    ),
    CommandContractEntry(
        id="car.automation.pause",
        path=("car", "automation", "pause"),
        requires_bound_workspace=False,
        status="partial",
        telegram_commands=("automation",),
        discord_paths=(("car", "automation", "pause"),),
        discord_ack_policy="defer_ephemeral",
        discord_exposure="public",
    ),
    CommandContractEntry(
        id="car.automation.resume",
        path=("car", "automation", "resume"),
        requires_bound_workspace=False,
        status="partial",
        telegram_commands=("automation",),
        discord_paths=(("car", "automation", "resume"),),
        discord_ack_policy="defer_ephemeral",
        discord_exposure="public",
    ),
    CommandContractEntry(
