...
This module belongs to `adapters/chat` because it defines adapter-layer UX
...
CHAT_UX_STATE_DESCRIPTORS: dict[ChatOperationState, ChatUxStateDescriptor] = {
    ...
    ChatOperationState.ACKNOWLEDGED: ChatUxStateDescriptor(
    ...
    ChatOperationState.VISIBLE: ChatUxStateDescriptor(
    ...
    ChatOperationState.INTERRUPTING: ChatUxStateDescriptor(
