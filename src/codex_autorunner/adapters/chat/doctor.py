...
_DISCORD_SERVICE = "src/codex_autorunner/adapters/discord/service.py"
_TELEGRAM_TRIGGER_MODE = "src/codex_autorunner/adapters/telegram/trigger_mode.py"
_TELEGRAM_MESSAGES = "src/codex_autorunner/adapters/telegram/handlers/messages.py"
