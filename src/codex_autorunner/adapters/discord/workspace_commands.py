...
from ...adapters.app_server.errors import CodexAppServerError
from ...adapters.chat.command_diagnostics import (
    ActiveFlowInfo,
    build_status_text,
)
from ...adapters.chat.help_catalog import build_discord_help_lines
from ...adapters.chat.picker_filter import filter_picker_items, resolve_picker_query
...
async def _read_status_rate_limits(
    ...
    *,
    ...
    if client is None:
        return None
    from ...adapters.chat.status_diagnostics import extract_rate_limits
