...
from ...adapters.app_server.client import ApprovalDecision, CodexAppServerClient
...
from ...adapters.chat.channel_directory import ChannelDirectoryStore
from ...adapters.chat.collaboration_policy import (
...
from ...adapters.chat.command_diagnostics import (
    ActiveFlowInfo,
)
from ...adapters.chat.dispatcher import (
    ChatDispatcher,
    DispatchContext,
    DispatchResult,
    conversation_id_for,
)
from ...adapters.chat.forwarding import compose_forwarded_message_text
from ...adapters.chat.handlers.approvals import (
    normalize_backend_approval_request,
)
from ...adapters.chat.managed_thread_delivery_worker import (
...
from ...adapters.chat.media import (
...
from ...adapters.chat.run_mirror import ChatRunMirror
from ...adapters.chat.turn_policy import (
    ...
    async def _handle_car_interrupt(
        ...
        *,
        ...
        await self._run_effectful_handler(
            ...
            dispatcher_conversation_id=dispatcher_conversation_id,
            source=source,
