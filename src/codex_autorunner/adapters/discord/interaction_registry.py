...
_SLASH_ROUTES: tuple[SlashCommandRoute, ...] = (
    ...
    SlashCommandRoute(
        id="car.retire",
        canonical_path=("car", "retire"),
        registered_path=("car", "retire"),
        description="Retire workspace state for a fresh start",
        handler=lambda *args, **kwargs: _dispatch_service_method(
            *args,
            **kwargs,
            method_name="_handle_car_retire",
            include_channel_id=True,
        ),
        ack_policy="defer_ephemeral",
        exposure="public",
    ...
    SlashCommandRoute(
        ...
        canonical_path=("car", "automation", "list"),
        registered_path=("car", "automation", "list"),
        description="List scheduled automations",
        handler=lambda *args, **kwargs: _dispatch_service_method(
            *args,
            **kwargs,
            method_name="_handle_automation_list",
            include_options=True,
        ),
        ack_policy="defer_ephemeral",
        exposure="public",
        group_description=GROUP_DESCRIPTIONS[("car", "automation")],
    ),
    SlashCommandRoute(
        id="car.automation.status",
        canonical_path=("car", "automation", "status"),
        registered_path=("car", "automation", "status"),
        description="Show one automation",
        handler=lambda *args, **kwargs: _dispatch_service_method(
            *args,
            **kwargs,
            method_name="_handle_automation_status",
            include_options=True,
        ),
        options_factory=_automation_id_options,
        ack_policy="defer_ephemeral",
        exposure="public",
        group_description=GROUP_DESCRIPTIONS[("car", "automation")],
    ),
    SlashCommandRoute(
        id="car.automation.run",
        canonical_path=("car", "automation", "run"),
        registered_path=("car", "automation", "run"),
        description="Run one automation now",
        handler=lambda *args, **kwargs: _dispatch_service_method(
            *args,
            **kwargs,
            method_name="_handle_automation_run",
            include_options=True,
        ),
        options_factory=_automation_id_options,
        ack_policy="defer_ephemeral",
    ...
    SlashCommandRoute(
        id="car.automation.pause",
        canonical_path=("car", "automation", "pause"),
        registered_path=("car", "automation", "pause"),
        description="Pause one automation",
        handler=lambda *args, **kwargs: _dispatch_service_method(
            *args,
            **kwargs,
            method_name="_handle_automation_pause",
            include_options=True,
        ),
        options_factory=_automation_id_options,
        ack_policy="defer_ephemeral",
    ...
    SlashCommandRoute(
        id="car.automation.resume",
        canonical_path=("car", "automation", "resume"),
        registered_path=("car", "automation", "resume"),
        description="Resume one automation",
        handler=lambda *args, **kwargs: _dispatch_service_method(
            *args,
            **kwargs,
            method_name="_handle_automation_resume",
            include_options=True,
        ),
        options_factory=_automation_id_options,
        ack_policy="defer_ephemeral",
    ...
    SlashCommandRoute(
        ...
        options_factory=_pma_on_options,
        ack_policy="immediate",
        exposure="public",
