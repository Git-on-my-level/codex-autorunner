...
The Discord interaction runtime (ingress, command runner, interaction dispatch) lives in `adapters/discord/`. This surface package re-exports the Discord-facing surface for layering purposes.
