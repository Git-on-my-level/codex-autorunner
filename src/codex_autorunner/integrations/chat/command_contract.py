...
COMMAND_CONTRACT: tuple[CommandContractEntry, ...] = (
    ...
    CommandContractEntry(
        ...
        status="stable",
        telegram_commands=("pma",),
        discord_paths=(("pma", "target", "rm"),),
        required_capabilities=("pma_delivery_targets",),
    ),
    CommandContractEntry(
        id="pma.target.clear",
        path=("pma", "target", "clear"),
        requires_bound_workspace=False,
        status="stable",
        telegram_commands=("pma",),
        discord_paths=(("pma", "target", "clear"),),
        required_capabilities=("pma_delivery_targets",),
    ),
    CommandContractEntry(
        id="pma.thread.list",
        path=("pma", "thread", "list"),
        requires_bound_workspace=False,
        status="stable",
        telegram_commands=("pma",),
        discord_paths=(("pma", "thread", "list"),),
        required_capabilities=("pma_managed_threads",),
    ),
    CommandContractEntry(
        id="pma.thread.info",
        path=("pma", "thread", "info"),
        requires_bound_workspace=False,
        status="stable",
        telegram_commands=("pma",),
        discord_paths=(("pma", "thread", "info"),),
        required_capabilities=("pma_managed_threads",),
    ),
    CommandContractEntry(
        id="pma.thread.archive",
        path=("pma", "thread", "archive"),
        requires_bound_workspace=False,
        status="stable",
        telegram_commands=("pma",),
        discord_paths=(("pma", "thread", "archive"),),
        required_capabilities=("pma_managed_threads",),
    ),
    CommandContractEntry(
        id="pma.thread.resume",
        path=("pma", "thread", "resume"),
        requires_bound_workspace=False,
        status="stable",
        telegram_commands=("pma",),
        discord_paths=(("pma", "thread", "resume"),),
        required_capabilities=("pma_managed_threads",),
    ),
    CommandContractEntry(
        id="car.resume",
