...
export function formatTokensAxis(val: number | string | null | undefined): string {
...
export function usageSeriesSignature(data: UsageChartData | null): string {
  if (!data) return "none";
...
export function getChartSize(container: HTMLElement, fallbackWidth: number, fallbackHeight: number): { width: number; height: number } {
...
export function limitSeries(series: SeriesEntry[], maxSeries: number, restKey: string): { series: SeriesEntry[] } {
...
export function normalizeSeries(series: SeriesEntry[], length: number): { series: SeriesEntry[] } {
...
export function setChartLoading(container: HTMLElement | null, loading: boolean): void {
  if (!container) return;
