...
Legacy terminal/debug screens may still exist during the Web Hub migration, but
...
- **Web Hub**: The primary web UI. `/pma` is the default landing page, with dashboard, repos, worktrees, tickets, contextspace, and settings as supporting routes.
